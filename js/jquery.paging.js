...
(function ($, window, undefined) {
     ...
     $["fn"]["paging"] = function (number, opts) {
             ...
             Paging = {
                 ...
                 "setPage": function (page) {
                     ...
                     function buffer_append(opts, data, type) {
                         ...
                         if (data["value"]) buffer += type.replace(/<a/i, '<a data-page="' + data["value"] + '"');
                         else buffer += type
                     }
         ...
         if(number < opts["perpage"]) this.hide(); else this.show();
         //if(v < this.w["perpage"]) this.hide(); else this.show();
