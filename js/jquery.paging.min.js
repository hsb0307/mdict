...
*/
(function(a,i){function c(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,"$1")}var d,f=a.event.special,n=document.documentMode,k="onhashchange"in i&&(void 0===n||n>7);a.fn.hashchange=function(a){return a?this.bind("hashchange",a):this.trigger("hashchange")};a.fn.hashchange.delay=50;f.hashchange=a.extend(f.hashchange,{setup:function(){if(k)return!1;a(d.start)},teardown:function(){if(k)return!1;a(d.stop)}});d=function(){function d(a){return a}function l(){var e=c(),b=f(j);if(e!==j)m(j=e,
b),a(i).trigger("hashchange");else if(b!==j)location.href=location.href.replace(/#.*/,"")+b;g=i.setTimeout(l,a.fn.hashchange.delay)}var h={},g,j=c(),m=d,f=d;h.start=function(){g||l()};h.stop=function(){g&&i.clearTimeout(g);g=void 0};a.browser.msie&&!k&&function(){var e,b;h.start=function(){if(!e)b=(b=a.fn.hashchange.src)&&b+c(),e=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){b||m(c());l()}).attr("src",b||"javascript:0").insertAfter("body")[0].contentWindow,document.onpropertychange=
function(){try{"title"===event.propertyName&&(e.document.title=document.title)}catch(a){}}};h.stop=d;f=function(){return c(e.location.href)};m=function(b,d){var c=e.document,f=a.fn.hashchange.domain;if(b!==d)c.title=document.title,c.open(),f&&c.write('<script>document.domain="'+f+'"<\/script>'),c.close(),e.location.hash=b}}();return h}()})(jQuery,this);
...
return this}};if(v < w["perpage"]) this.hide(); else this.show(); return s.setNumber(v).setOptions(w).setPage()}})(jQuery,this);